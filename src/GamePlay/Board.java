...
public class Board {
    ...
    /**
     * Check a paint when the seed doesn't match with 3 in the row or column
     * @return Return true if it is a draw (i.e., no more EMPTY cell)
     */
    ...
    /**
     * Check a paint when the seed matches with 3 in the row or column
     * @return Return true if the player with "theSeed" has won after placing at (currentRow, currentCol)
     */
